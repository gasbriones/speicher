...
<?php if (is_single() || is_page()): ?>
  <meta content="<?php echo get_the_excerpt();?>" name="description">
<?php else: ?>
...
<?php if (is_single() || is_page()): ?>
    ...
    <meta name="og:description" content="<?php echo custom_excerpt($post_id);?>"/>
...
<?php if (is_single() || is_page()): ?>
    ...
    <meta name="twitter:description" content="<?php echo custom_excerpt($post_id);?>" />
<?php else: ?>
    <meta name="twitter:card" content="summary" />
                            ...
                            <div class="menu-content wrapper">
                                ...
                                <div class="block no-right">
                                    <h3>Apps</h3>
                                      <ul class="block-list">
                                        <li>
                                          <a title="Android" href="https://play.google.com/store/apps/details?id=com.tn&amp;feature=search_result#?t=W251bGwsMSwxLDEsImNvbS50biJd">Android</a>
                                        </li>
                                        <li>
                                          <a title="iPad" href="https://itunes.apple.com/us/app/tn-hd/id391803698?mt=8">iPad</a>
                                        </li>
                                        <li>
                                          <a title="iPhone" href="https://itunes.apple.com/us/app/tn/id391573980?mt=8">iPhone</a>
                                        </li>
                                        <li>
                                          <a title="Windows" href="http://www.windowsphone.com/es-es/store/app/tn/f497841e-7d12-4fc4-8596-bcd9c9fa4cf1">Windows</a>
                                        </li>
                                        <li>
                                          <a title="Blackberry" href="http://appworld.blackberry.com/webstore/content/46472890/?lang=es&amp;countrycode=AR">Blackberry</a>
                                        </li>
                                        <li>
                                          <a title="TN Flip" href="http://tn.com.ar/flip">TN Flip</a>
                                        </li>
                                        <li>
                                          <a title="Flipboard" href="http://flpbd.it/todonoticias">Flipboard</a>
                                        </li>
                                        <li>
                                          <a title="Chrome" href="https://chrome.google.com/webstore/detail/tn-todo-noticias/mfdljeahedcobnjhjkabpeafoicpkcgm">Chrome</a>
                                        </li>
                                      </ul>
                                </div>
                            </div>
