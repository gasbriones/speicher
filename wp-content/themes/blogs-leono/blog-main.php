<section id="blog-main" class="clearfix" role="main">
    ...
    <?php if ( have_posts() ) : ?>
        ...
        <?php while ( have_posts() ) : the_post();  ?>
            ...
            <h1 class="post-title" ><a class="entry-title" href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a></h1>
            ...
            <div class="share clearfix">
                <div class="social">
                    <a href="https://twitter.com/intent/tweet?text=<?php echo get_the_title();?>&url=<?php echo get_permalink();?>&via=todonoticias" target="_new" class="share-item icon tw"></a>
                ...
                <ul class="post-extras">
                    <li class="first"><a href="<?php the_permalink() ?>">Enlace permanente</a></li>
                    <li>|</li>
                    <li><a href="<?php echo get_permalink()."#disqus_thread" ?>">comentarios</a></li>
    ...
    <footer class="pager wrapper clearfix">
